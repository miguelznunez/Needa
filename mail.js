...
activateAccountEmail = (email, id, token, cb) => {
  ...
  var mailOptions = {
      ...
      html: `<p>Please click on the following link, or paste it into your browser to complete the account activation process:<br><br><a href="https://code-foxx.com/activate-account/${id}/${token}">https://code-foxx.com/activate-account/${id}/${token}</a><br><br>The Team</p>`
  };
